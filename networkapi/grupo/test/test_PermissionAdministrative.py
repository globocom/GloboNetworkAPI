...
class PermissionAdministrativeConsultationTest(
        PermissionAdministrativeConfigTest,
        ConsultationTest):
...
class PermissionAdministrativeTest(
        PermissionAdministrativeConfigTest,
        AttrTest):
    ...
    def test_save_duplicate(self):
        ...
        self._attr_invalid(
            response,
            CodeError.PERMISSION_ADMINISTRATIVE_DUPLICATE)
...
class PermissionAdministrativeRemoveTest(
        PermissionAdministrativeConfigTest,
        RemoveTest):
...
class PermissionAdministrativeAttrPermissionTest(
        PermissionAdministrativeConfigTest,
        AttrTest):
...
class PermissionAdministrativeAttrGroupTest(
        PermissionAdministrativeConfigTest,
        AttrTest):
...
class PermissionAdministrativeAttrReadTest(
        PermissionAdministrativeConfigTest,
        AttrTest):
...
class PermissionAdministrativeAttrWriteTest(
        PermissionAdministrativeConfigTest,
        AttrTest):
...
@me
class PermissionAdministrativeGetByUGroupTest(
        PermissionAdministrativeConfigTest,
        AttrTest):
    ...
    def test_get_by_ugroup_valid(self):
        response = self.client_autenticado().get(
            self.URL_LIST_BY_GROUP %
            self.ID_UGROUP_VALID)
        valid_response(response)
