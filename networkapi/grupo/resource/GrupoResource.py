    ...
    def handle_post(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            return self.response(
                dumps_networkapi({'grupo': {'id': egroup.id}}))
...
class DireitoGrupoEquipamentoResource(RestResource):
    ...
    def __valida_id_ugrupo(self, id_grupo):
        ...
        try:
            ...
            self.log.error(
                u'Valor do id_grupo_usuario inválido: %s.',
                id_grupo)
    ...
    def __valida_id_egrupo(self, id_grupo):
        ...
        try:
            ...
            self.log.error(
                u'Valor do id_grupo_equipamento inválido: %s.',
                id_grupo)
            return self.response_error(102)
    ...
    def handle_post(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            return self.response(
                dumps_networkapi({'direito_grupo_equipamento': {'id': direito.id}}))
        except InvalidValueError as e:
            return self.response_error(269, e.param, e.value)
        except UGrupo.DoesNotExist:
            return self.response_error(
                180,
                direito_map.get('id_grupo_usuario'))
        except EGrupoNotFoundError:
            return self.response_error(102)
