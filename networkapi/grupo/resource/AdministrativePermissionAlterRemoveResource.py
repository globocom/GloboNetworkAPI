    ...
    def handle_put(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            with distributedlock(LOCK_PERM % id_perm):
                ...
                try:
                    perm = PermissaoAdministrativa.get_permission_by_permission_ugroup(id_permission, id_group)
                ...
                try:
                    ...
                    self.log.error(u'Failed to update the administrative permission.')
                    raise PermissionError(e, u'Failed to update the administrative permission.')
