    ...
    def get_by_pk(cls, id):
        ...
        try:
            ...
            raise UGrupoNotFoundError(
                e,
                u'Dont there is a Group Use by pk = %s.' %
                id)
    ...
    def get_by_pk(cls, pk):
        ...
        try:
            ...
            raise PermissionNotFoundError(
                e,
                u'There is Permission with pk = %s.' %
                pk)
        except Exception as e:
...
class PermissaoAdministrativa(BaseModel):
    id = models.AutoField(
        primary_key=True,
        db_column='id_permissoes_administrativas')
    ...
    def create(self, authenticated_user):
        ...
        try:
            ...
            raise PermissaoAdministrativaDuplicatedError(
                None,
                u'Permissão administrativa com grupo de usuário %s e função %s já cadastrada' %
                (self.ugrupo.id,
                 self.funcao))
        ...
        except UGrupo.DoesNotExist as e:
            raise e
        except Exception as e:
            self.log.error(u'Falha ao inserir uma Permissao Administrativa.')
            raise GrupoError(
                e,
                u'Falha ao inserir uma Permissao Administrativa.')
    ...
    def get_by_pk(cls, pk):
        ...
        try:
            ...
            raise PermissaoAdministrativaNotFoundError(
                e,
                u'Não existe uma Permissao Administrativa com a pk = %s.' %
                pk)
        except Exception as e:
            cls.log.error(u'Falha ao pesquisar uma Permissao Administrativa.')
            raise GrupoError(
                e,
                u'Falha ao pesquisar uma Permissao Administrativa.')
    # ok

    @classmethod
    def get_permission_by_function_ugroup(cls, function, ugroup_id):
        try:
            return PermissaoAdministrativa.objects.filter(
                permission__function=function,
                ugrupo__id=ugroup_id)[
                0:1].get()
        except ObjectDoesNotExist as o:
            raise PermissaoAdministrativaNotFoundError(
                o, 'Grupo do Usuário %s não tem permissão na função %s.' %
                (ugroup_id, function))
        except Exception as e:
            cls.log.error(u'Falha ao pesquisar a permissão administrativa.')
            raise GrupoError(
                e,
                u'Falha ao pesquisar a permissão administrativa.')
    ...
    def get_permission(self, function, ugroup, operation):
        ...
        try:
            ...
            raise PermissaoAdministrativaNotFoundError(
                o, 'Grupo do Usuário %s não tem permissão de %s na função %s.' %
                (ugroup.nome, operation, function))
        except Exception as e:
            self.log.error(
...
class EGrupo(BaseModel):
    ...
    def get_by_pk(cls, pk):
        try:
            ...
            raise EGrupoNotFoundError(
                e,
                u'Não existe um egrupo com a pk = %s.' %
                pk)
        except Exception as e:
    ...
    def search(cls):
        try:
            ...
            raise GrupoError(
                e,
                u'Falha ao pesquisar os grupos de equipamento.')
    ...
    def create(self, authenticated_user):
        ...
        except EGrupoNameDuplicatedError as e:
            raise e
        except Exception as e:
...
class DireitosGrupoEquipamento(BaseModel):
    ...
    def get_by_pk(cls, pk):
        ...
        except DireitosGrupoEquipamento.DoesNotExist as e:
            raise e
        except Exception as e:
            cls.log.error(
    ...
    def create(self, authenticated_user):
        ...
        try:
            ...
            if DireitosGrupoEquipamento.objects.filter(
                    egrupo__id=self.egrupo.id,
                    ugrupo__id=self.ugrupo.id).count() > 0:
            ...
            raise e
        except DireitoGrupoEquipamentoDuplicatedError as e:
            raise e
        except Exception as e:
            self.log.error(
