...
class IPv4FunctionalTestV3(NetworkApiTestCase):
    ...
    def setUp(self):
        ...
        self.not_expect_ip_msg_err = \
            'IPv4 with id %s retrieved was not expect in response.'
    ...
    def test_try_delete_ipv4_assoc_to_equipment(self):
        """Tests if NAPI can delete an IPv4 Address associated
        to some equipment.
        """
    ...
    def test_try_create_auto_ip(self):
        ...
        response = self.client.post(
            ...
            data=json.dumps(self.load_json_file(
                'api_ip/tests/v3/'
                'functional/json/ipv4_auto_net_free.json'
            )),
    ...
    def test_try_create_invalid_ip(self):
        ...
        response = self.client.post(
            ...
            data=json.dumps(self.load_json_file(
                'api_ip/tests/v3/'
                'functional/json/ipv4_10_0_0_430_net_5.json'
            )),
            content_type='application/json',
            HTTP_AUTHORIZATION=self.get_http_authorization('test'))
    ...
    def test_try_create_ip_associating_to_equipment(self):
        """Tests if NAPI can allocate an IPv4 Address manually and associate it to
        ...
        response = self.client.post(
            ...
            data=json.dumps(self.load_json_file(
                'api_ip/tests/v3/'
                'functional/json/ipv4_10_0_0_99_net_5_eqpt_99.json'
            )),
            content_type='application/json',
            HTTP_AUTHORIZATION=self.get_http_authorization('test'))
    ...
    def test_try_create_ip_in_full_network(self):
        ...
        response = self.client.post(
            ...
            data=json.dumps(self.load_json_file(
                'api_ip/tests/v3/'
                'functional/json/ipv4_198_168_1_5_net_8.json'
            )),
            content_type='application/json',
            HTTP_AUTHORIZATION=self.get_http_authorization('test'))
    ...
    def test_try_create_out_of_range_ip_in_network(self):
        ...
        response = self.client.post(
            ...
            data=json.dumps(self.load_json_file(
                'api_ip/tests/v3/'
                'functional/json/out_of_range_ipv4_172_0_0_5_net_5.json'
            )),
            content_type='application/json',
            HTTP_AUTHORIZATION=self.get_http_authorization('test'))
    ...
    def test_try_update_ip_associating_to_equipment(self):
        ...
        response = self.client.put(
            ...
            data=json.dumps(self.load_json_file(
                'api_ip/tests/v3/'
                'functional/json/ipv4_put_90_net_5_eqpt_90.json'
            )),
            content_type='application/json',
            HTTP_AUTHORIZATION=self.get_http_authorization('test'))
    ...
    def test_try_update_ip_disassociating_it_of_all_equipments(self):
        ...
        response = self.client.put(
            ...
            data=json.dumps(self.load_json_file(
                'api_ip/tests/v3/'
                'functional/json/ipv4_put_91_net_5_eqpt_none.json'
            )),
            content_type='application/json',
            HTTP_AUTHORIZATION=self.get_http_authorization('test'))
    ...
    def test_try_update_ip_disassociating_it_of_some_equipments(self):
        """Tests if NAPI can update IPv4 disassociating it of equipment and
           maintaning this IPv4 in database given it is used in anymore equipment.
        """
        ...
        response = self.client.put(
            ...
            data=json.dumps(self.load_json_file(
                'api_ip/tests/v3/'
                'functional/json/ipv4_put_92_net_5_eqpt_none.json'
            )),
            content_type='application/json',
            HTTP_AUTHORIZATION=self.get_http_authorization('test'))
    ...
    def test_try_update_ip_disassociating_it_of_equipments_and_associating_to_others_after(self):
        ...
        response = self.client.put(
            ...
            data=json.dumps(self.load_json_file(
                'api_ip/tests/v3/'
                'functional/json/ipv4_put_93_net_5_eqpt_none.json'
            )),
            content_type='application/json',
            HTTP_AUTHORIZATION=self.get_http_authorization('test'))
    ...
    def test_try_update_ip_changing_network(self):
        ...
        response = self.client.put(
            ...
            data=json.dumps(self.load_json_file(
                'api_ip/tests/v3/'
                'functional/json/ipv4_put_67_net_8.json'
            )),
            content_type='application/json',
            HTTP_AUTHORIZATION=self.get_http_authorization('test'))
    ...
    def test_try_update_ip_changing_octets(self):
        ...
        response = self.client.put(
            ...
            data=json.dumps(self.load_json_file(
                'api_ip/tests/v3/'
                'functional/json/ipv4_put_67_10_0_0_68_net_5.json'
            )),
            content_type='application/json',
            HTTP_AUTHORIZATION=self.get_http_authorization('test'))
