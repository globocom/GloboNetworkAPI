...
class IPv4DeleteTestCase(NetworkApiTestCase):
    ...
    def test_try_delete_existent_ipv4(self):
        ...
        self.compare_values(
            u'Causa: , Mensagem: There is no IP with pk = 1.',
    ...
    def test_try_delete_ipv4_assoc_to_equipment(self):
        ...
        self.compare_values(
            u'Causa: , Mensagem: There is no IP with pk = 2.',
            response.data['detail']
        )
    ...
    def test_try_delete_ipv4_used_by_not_created_vip_request(self):
        ...
        self.compare_values(
            u'Causa: , Mensagem: There is no IP with pk = 4.',
            response.data['detail']
        )
    ...
    def test_try_delete_ipv4_used_by_created_vip_request(self):
        ...
        self.compare_values(
            u'Causa: 2, Mensagem: IPv4 can not be removed because it is in use'
            ' by Vip Request 2',
            response.data['detail']
        )
