...
class OptionVipGetBalanceamentoByEVipResource(RestResource):
    ...
    log = Log('OptionVipGetBalanceamentoByEVipResource')
    ...
    def handle_get(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            return self.response(
                dumps_networkapi({'balanceamento_opt': ovip_list}))
        ...
        except OptionVipError as EnvironmentVipError:
