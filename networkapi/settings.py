...
SPECS = {
    ...
    'as_post_v4': os.path.join(
        PROJECT_ROOT_PATH,
        'networkapi/api_as/v4/specs/as_post.json'
    ),
    'as_put_v4': os.path.join(
        PROJECT_ROOT_PATH,
        'networkapi/api_as/v4/specs/as_put.json'
    ),
    'equipment_post_v4': os.path.join(
        PROJECT_ROOT_PATH,
        'networkapi/api_equipment/v4/specs/equipment_post.json'
    ),
    'equipment_put_v4': os.path.join(
        PROJECT_ROOT_PATH,
        'networkapi/api_equipment/v4/specs/equipment_put.json'
    ),
    'ipv4_post_v4': os.path.join(
        PROJECT_ROOT_PATH,
        'networkapi/api_ip/v4/specs/ipv4_post.json'
    ),
    'ipv4_put_v4': os.path.join(
        PROJECT_ROOT_PATH,
        'networkapi/api_ip/v4/specs/ipv4_put.json'
    ),
    'ipv6_post_v4': os.path.join(
        PROJECT_ROOT_PATH,
        'networkapi/api_ip/v4/specs/ipv6_post.json'
    ),
    'ipv6_put_v4': os.path.join(
        PROJECT_ROOT_PATH,
        'networkapi/api_ip/v4/specs/ipv6_put.json'
    ),
    'virtual_interface_post_v4': os.path.join(
        PROJECT_ROOT_PATH,
        'networkapi/api_virtual_interface/v4/specs/virtual_interface_post.json'
    ),
    'virtual_interface_put_v4': os.path.join(
        PROJECT_ROOT_PATH,
        'networkapi/api_virtual_interface/v4/specs/virtual_interface_put.json'
    ),
    'neighbor_post_v4': os.path.join(
        PROJECT_ROOT_PATH,
        'networkapi/api_neighbor/v4/specs/neighbor_post.json'
    ),
    'neighbor_put_v4': os.path.join(
        PROJECT_ROOT_PATH,
        'networkapi/api_neighbor/v4/specs/neighbor_put.json'
    )
}
