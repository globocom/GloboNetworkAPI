...
class Rule(BaseModel):
    ...
    environment = models.ForeignKey(Ambiente, db_column='id_ambiente', null=False)
    name = models.CharField(max_length=80, blank=False, null=False, db_column='name')
    vip = models.ForeignKey(RequisicaoVips, db_column='id_vip', null=True, related_name='vip')
...
class RuleContent(BaseModel):
    ...
    rule = models.ForeignKey(Rule, null=False, db_column='id_rule', on_delete=models.CASCADE)
