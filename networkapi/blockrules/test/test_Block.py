...
class BlockConsultationTest(BlockConfigTest, ConsultationTest):
    ...
    def test_get_by_environment(self):
        ...
        response = self.client_autenticado().get(
            self.URL_GET_BLOCK % self.ID_VALID)
