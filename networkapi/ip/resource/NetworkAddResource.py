    ...
    def handle_post(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            if environment_vip is not None:
                ...
                if any(
                        int(environment_vip) == item['id'] for item in evip_list):
            ...
            try:
                ...
                list_equip_routers_ambient = EquipamentoAmbiente.objects.filter(
                    ambiente=network_ip.vlan.ambiente.id,
                    is_router=True)
        ...
        except NetworkIPRangeEnvError as e:
        ...
        except (IpError, NetworkIPv6Error, NetworkIPv4Error, GrupoError, VlanError) as e:
