    ...
    def handle_delete(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            if not is_valid_int_greater_zero_param(network_ipv4_id):
                self.log.error(u'Parameter id_network_ipv4 is invalid. Value: %s.', network_ipv4_id)
                raise InvalidValueError(None, 'id_network_ipv4', network_ipv4_id)
            ...
            with distributedlock(LOCK_NETWORK_IPV4 % network_ipv4_id):
                ...
                key_list_eqs = Equipamento.objects.filter(ipequipamento__ip__networkipv4=network_ipv4).values_list('id', flat=True)
