            ...
            with distributedlock(LOCK_NETWORK_IPV4 % network_ipv4_id):
                ...
                try:
                    ...
                    try:
                        ...
                        #Ip %s.%s.%s.%s already has association with Equipament %s.' % (self.oct1, self.oct2, self.oct3, self.oct4,equipment_id)
                        raise IpEquipmentAlreadyAssociation(None,u'Ip %s.%s.%s.%s already has association with Equipament %s.' % (ip.oct1, ip.oct2, ip.oct3, ip.oct4, equip_id))
                    ...
                    ip_equips = IpEquipamento.objects.filter(equipamento=equip_id)
                    ...
                    self.log.error(e)
                    raise IpNotAvailableError(None, u'Ip %s.%s.%s.%s is invalid' % (ip.oct1, ip.oct2, ip.oct3, ip.oct4))
                except IpNotAvailableError, e:
                    raise IpNotAvailableError(None, u'Ip %s.%s.%s.%s not available for network %s.' % (ip.oct1, ip.oct2, ip.oct3, ip.oct4, net.id))
