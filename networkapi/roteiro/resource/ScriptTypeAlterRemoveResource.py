            ...
            with distributedlock(LOCK_SCRIPT_TYPE % id_script_type):
                ...
                try:
                    if script_type.tipo.lower() != type.lower():
                        ...
                        raise TipoRoteiroNameDuplicatedError(None, u'Já existe um tipo de roteiro com o tipo %s.' % type)
            ...
            with distributedlock(LOCK_SCRIPT_TYPE % id_script_type):
                ...
                try:
                    ...
                    if script_type.roteiro_set.count() != 0:
                        raise TipoRoteiroHasRoteiroError(None, u'Existe roteiros associado ao tipo de roteiro %d' % script_type.id)
