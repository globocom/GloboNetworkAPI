...
urlpatterns = patterns('',
    url(r'^$', script_add_resource.handle_request,
        name='script.add'),
    url(r'^all/$', script_get_all_resource.handle_request,
        name='script.get.all'),
    ...
    url(r'^equipment/(?P<id_equipment>[^/]+)/$', script_get_equipment_resource.handle_request,
        name='script.get.equipment')
)
