...
urlpatterns = patterns('',
    ...
    url(r'^get/(?P<id_script>[^/]+)/$', script_get_all_resource.handle_request, name='script.get.by.id'),
    url(r'^edit/(?P<id_script>[^/]+)/$', script_alter_remove_resource.handle_request, name='script.update.remove.by.pk'),
    url(r'^(?P<id_script>[^/]+)/$', script_alter_remove_resource.handle_request, name='script.update.remove.by.pk'),
    url(r'^scripttype/(?P<id_script_type>[^/]+)/$', script_get_script_type_resource.handle_request,
        name='script.get.script_type'),
    url(r'^equipment/(?P<id_equipment>[^/]+)/$', script_get_equipment_resource.handle_request, name='script.get.equipment'),
