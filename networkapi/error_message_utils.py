...
error_messages = {
     ...
     326:u'Não foi possível recuperar o equipamento %s associado a um real server.',  # VipRequest Real server equipment error
     327:u'Não foi possível recuperar o ip %s e equipamento %s associados ao real server.',  # VipRequest Real server equipment ip association error
     328:u'Não foi possível recuperar o IP %s associado ao real server %s.',  # VipRequest Real server ip doesn't exist
     ...
     # 333:u'Alteração de real server realizada com sucesso, mas ocorreram erros de script com o(s) real(s) %s e ip(s) %s.',
