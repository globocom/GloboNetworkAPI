    ...
    def handle_put(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            if not is_valid_int_greater_zero_param(id_groupl3):
                self.log.error(u'The id_groupl3 parameter is not a valid value: %s.', id_groupl3)
            ...
            with distributedlock(LOCK_GROUP_L3 % id_groupl3):
                ...
                try:
                    if groupl3.nome.lower() != name.lower():
                        ...
                        raise GrupoL3NameDuplicatedError(None, u'Já existe um grupo l3 com o valor name %s.' % name)
            ...
            with distributedlock(LOCK_GROUP_L3 % id_groupl3):
                ...
                try:
                    ...
                    if groupl3.ambiente_set.count() > 0:
                        raise GrupoL3UsedByEnvironmentError(None, u"O GrupoL3 %s tem ambiente associado." % groupl3.id)
