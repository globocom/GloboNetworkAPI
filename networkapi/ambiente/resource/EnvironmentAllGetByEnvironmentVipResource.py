...
class EnvironmentAllGetByEnvironmentVipResource(RestResource):
    ...
    log = Log('EnvironmentAllGetByEnvironmentVipResource')
    ...
    def handle_get(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            self.log.info("GET to list all the Environment by Environment Vip.")
            ...
            for env_env_vip in environment_vip.environmentenvironmentvip_set.all():
                ...
                environment_map['environment_vip_id'] = env_env_vip.environment_vip.id
                environment_map['environment'] = env_env_vip.environment.grupo_l3.nome
                environment_map['ambiente_logico_name'] = env_env_vip.environment.ambiente_logico.nome
                environment_map['divisao_dc_name'] = env_env_vip.environment.divisao_dc.nome
