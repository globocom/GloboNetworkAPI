...
from networkapi.api_equipment.v4 import facade as facade_v4
...
serializers = get_app('api_equipment', module_label='v4.serializers')

log = logging.getLogger(__name__)


class EquipmentV4View(CustomAPIView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        facade_v4.delete_equipment(obj_ids)
