...
urlpatterns = patterns('',
    url(r'^$', model_add_resource.handle_request,
        name='model.add'),
    url(r'^all/$', model_get_all_resource.handle_request,
        name='model.get.all'),
    url(r'^(?P<id_model>[^/]+)/$', model_alter_remove_resource.handle_request,
        name='model.update.remove.by.pk'),
    url(r'^brand/(?P<id_brand>[^/]+)/$', model_get_by_brand_resource.handle_request,
        name='model.get.by.brand')
)