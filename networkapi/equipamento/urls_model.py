...
urlpatterns = patterns('',
    ...
    url(r'^(?P<id_model>[^/]+)/$', model_alter_remove_resource.handle_request, name='model.update.remove.by.pk'),
    url(r'^brand/(?P<id_brand>[^/]+)/$', model_get_by_brand_resource.handle_request, name='model.get.by.brand'),
    url(r'^script/(?P<script_id>[^/]+)/$', model_get_all_resource.handle_request, name='model.get.all')
)