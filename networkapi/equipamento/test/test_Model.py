...
class ModelAttrNameTest(ModelConfigTest, AttrTest):
    ...
    def test_alter_unique(self):
        ...
        self.process_alter_attr_invalid(
            self.ID_ALTER_VALID, mock, CodeError.MODEL_DUPLICATE)
