...
class EquipmentEnvironmentTest(EquipmentEnvironmentConfigTest):
    ...
    def test_save_valid(self):
        ...
        from_db = EquipamentoAmbiente.objects.get(
            equipamento=self.ID_EQUIPMENT_VALID,
            ambiente=self.ID_ENVIRONMENT_VALID)
...
class EquipmentEnvironmentUpdateTest(EquipmentEnvironmentConfigTest, AttrTest):
    ...
    def test_update_valid(self):
        ...
        from_db = EquipamentoAmbiente.objects.get(
            equipamento=mock['id_equipamento'],
            ambiente=mock['id_ambiente'])
...
class EquipmentEnvironmentAttrEquipamentTest(
        EquipmentEnvironmentConfigTest,
        AttrTest):
...
class EquipmentEnvironmentAttrEnvironmentTest(
        EquipmentEnvironmentConfigTest,
        AttrTest):
...
class EquipmentEnvironmentRemoveTest(
        EquipmentEnvironmentConfigTest,
        RemoveTest):
    ...
    def test_remove_valid(self):
        response = self.client_autenticado().delete(
            self.URL_REMOVE %
            (self.ID_EQUIPMENT, self.ID_ENVIRONMENT))
        valid_response(response)
