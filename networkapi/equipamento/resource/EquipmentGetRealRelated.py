    ...
    def handle_get(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            if not is_valid_int_greater_zero_param(id_equip):
                self.log.error(u'The id_equip parameter is not a valid value: %s.', id_equip)
            ...
            for ip_equip in equipment.ipequipamento_set.all():
                ...
                for server_pool_member in ip.serverpoolmember_set.all():
                    ...
                    vip_port_to_pool = VipPortToPool.objects.get(server_pool__id = server_pool_id)
                    vip = RequisicaoVips.get_by_pk(vip_port_to_pool.requisicao_vip.id)
