...
from networkapi.distributedlock import distributedlock, LOCK_BRAND
    ...
    def handle_put(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            if brand_map is None:
                return self.response_error(
                    3,
                    u'There is no value to the brand tag  of XML request.')
                ...
                try:
                    if brand.nome.lower() != name.lower():
                        ...
                        raise MarcaNameDuplicatedError(
                            None,
                            u'Marca com o nome %s já cadastrada.' %
                            name)
                ...
                try:
                    ...
                    if brand.modelo_set.count() > 0:
                        raise MarcaUsedByModeloError(
                            None,
                            u"A marca %d tem modelo associado." %
                            brand.id)
