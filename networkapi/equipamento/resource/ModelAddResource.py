...
from networkapi.equipamento.models import Marca, MarcaNotFoundError, ModeloNotFoundError, MarcaModeloNameDuplicatedError, EquipamentoError, Modelo
    ...
    def handle_post(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            if not is_valid_int_greater_zero_param(id_brand):
                self.log.error(u'The id_brand parameter is not a valid value: %s.', id_brand)
            ...
            try:
                ...
                raise MarcaModeloNameDuplicatedError(None, u'Já existe um modelo com o nome %s com marca %s.' % (name, brand.nome ))
            ...
            model_map = dict()
            model_map['model'] = model_to_dict(model, exclude=["nome", "marca"])
