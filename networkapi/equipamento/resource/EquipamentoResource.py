...
def insert_equipment(equipment_map, user):
    ...
    if not is_valid_int_greater_zero_param(model_id):
        log.error(
            u'The model_id parameter is not a valid value: %s.',
            model_id)
...
class EquipamentoResource(RestResource):
    ...
    def handle_get(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            if (equipment_id is None) and (equipment_name is None) and (
                    equipment_type_id is None or environment_id is None):
                return super(
                    EquipamentoResource,
                    self).handle_get(
                    request,
...
class EquipamentoAmbienteResource(RestResource):
    ...
    def handle_post(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            equip_environment = EquipamentoAmbiente(
                equipamento=Equipamento(
                    id=equip_id), ambiente=Ambiente(
                    id=environment_id), is_router=is_router)
    ...
    def handle_put(self, request, user, *args, **kwargs):
        ...
        try:
            ...
            try:
                ...
                self.log.warning(
                    u'Falha ao alterar a associação equipamento/ambiente, associação não existe %s/%s.' %
                ...
                raise EquipamentoError(
                    e, u'Falha ao alterar a associação equipamento/ambiente: %s/%s.' %
                    (equip_id, environment_id))
