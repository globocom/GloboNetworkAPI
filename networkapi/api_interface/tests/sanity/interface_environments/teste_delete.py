...
class InterfaceEnvironmentsDeleteTestCase(NetworkApiTestCase):
    ...
    fixtures = [
        ...
        'networkapi/api_interface/fixtures/initial_interface_environments.json',
    ]
    ...
    def test_delete(self):
        """Test of success to delete one relationship between an interface and a environment."""

        interface_environments_id = "1"

        response = self.client.delete('/api/v3/interface/environments/%s/' % interface_environments_id,
