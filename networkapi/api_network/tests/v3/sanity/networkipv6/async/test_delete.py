...
class NetworkIPv6AsyncDeleteSuccessTestCase(NetworkApiTestCase):
    ...
    def test_task_id_create_in_delete_one_netipv6_success(self):
        """Test success of id task generate for netipv6 delete."""

        obj_id = 5
        response = tasks.delete_networkv6.apply(args=[obj_id],
                                                queue='napi.network')
...
class NetworkIPv6AsyncDeployDeleteSuccessTestCase(NetworkApiTestCase):
    ...
    def test_task_id_create_in_delete_deploy_netipv6_success(self, test_patch):
        """Test success of id task generate for netipv6 delete deploy and
           success for delete deploy netipv6.
        """
        ...
        obj_id = 1
        response = tasks.undeploy_networkv6.apply(
            args=[obj_id, self.user.id], queue='napi.network')
...
class NetworkIPv6AsyncDeployDeleteErrorTestCase(NetworkApiTestCase):
    ...
    @patch('networkapi.plugins.factory.PluginFactory.factory')
    def test_task_id_create_in_delete_deploy_netipv6_error(self, test_patch):
        """Test success of id task generate for netipv6 delete deploy and
           error for delete deploy netipv6.
        """
