...
class NetworkIPv4AsyncDeployDeleteSuccessTestCase(NetworkApiTestCase):
    ...
    def test_task_id_create_in_delete_deploy_netipv4_success(self, test_patch):
        """Test success of id task generate for netipv4 delete deploy and
           success for delete deploy netipv4.
        """
        ...
        obj_id = 1
        response = tasks.undeploy_networkv4.apply(
...
class NetworkIPv4AsyncDeployDeleteErrorTestCase(NetworkApiTestCase):
    ...
    @patch('networkapi.plugins.factory.PluginFactory.factory')
    def test_task_id_create_in_delete_deploy_netipv4_error(self, test_patch):
        """Test success of id task generate for netipv4 delete deploy and
           error for delete deploy netipv4.
        """
