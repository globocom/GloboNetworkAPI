...
class NetworkIPv4DeleteTestCase(NetworkApiTestCase):
    ...
    def test_try_delete_active_netipv4(self):
        """Tries to delete an active Network IPv4 without IP Addresses. NAPI should deny this request."""

        delete_url = '/api/v3/networkv4/1/'
    ...
    def test_try_delete_inactive_netipv4_with_ip_assoc_to_active_vip(self):
        """Tries to delete an inactive Network IPv4 with only one IP address associated to an active VIP Request. NAPI should deny this request."""

        delete_url = '/api/v3/networkv4/3/'
        ...
        get_url = '/api/v3/networkv4/3/?kind=basic'

        name_file = 'api_network/tests/v3/sanity/networkipv4/json/delete/basic/pk_3.json'
    ...
    def test_try_delete_inactive_netipv4_with_ip_assoc_to_inactive_vip(self):
        """Tries to delete an inactive Network IPv4 with only one IP address associated to an active VIP Request. NAPI should allow this request."""

        delete_url = '/api/v3/networkv4/4/'
    ...
    def test_try_delete_inactive_netipv4_with_ips(self):
        """Tries to delete a Network IPv4 with two IP Addresses not associated to any active VIP Request. NAPI should allow this request."""

        delete_url = '/api/v3/networkv4/6/'
    ...
    def test_try_undeploy_netipv4(self, test_patch):
        ...
        url_delete = '/api/v3/networkv4/deploy/1/'
