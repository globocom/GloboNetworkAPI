...
-- -----------------------------------------------------
-- Table `networkapi`.`modelo_roteiro`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `networkapi`.`modelo_roteiro` (
  ...
  CONSTRAINT `modelo_roteiro_id_roteiro`
    FOREIGN KEY (`id_roteiro`)
    REFERENCES `roteiros` (`id_roteiros`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `modelo_roteiro_id_modelo`
    FOREIGN KEY (`id_modelo`)
